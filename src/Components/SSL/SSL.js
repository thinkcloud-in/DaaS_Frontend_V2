...
const SSL = () => {
  ...
  const renderExpirationDetails = () => {
    if (!sslDetails) {
      return <span className="font-normal text-gray-500 dark:text-gray-400 animate-pulse">Fetching cluster details...</span>;
    }
    ...
    return (
      <div className="flex flex-col space-y-1 mt-1">
        <span className="font-semibold text-gray-800 dark:text-gray-100 text-sm">{sslDetails.valid_until}</span>
        ...
        {sslDetails.common_name && (
          <span className="text-xs text-gray-500 dark:text-gray-400 font-normal">Domain: {sslDetails.common_name}</span>
        )}
      </div>
    );
  };
  ...
  return (
    <div className="mt-5 flex flex-col space-y-6 w-[98%] h-[90vh] m-auto bg-white dark:bg-gray-800">
      <div className="p-8 rounded-lg flex flex-col items-start m-10 bg-white dark:bg-gray-800">
        <h1 className="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100 border-b-2 border-gray-200 dark:border-gray-700">SSL Certificate</h1>
        
        <div className="mb-6 flex flex-col items-start w-full">
          <label className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Certificate Type:</label>
          <div className="flex items-center space-x-6">
            <label className="flex items-center cursor-pointer">
              <input
                ...
                className="w-4 h-4 text-[#1a365d] dark:text-blue-300 focus:ring-2 focus:ring-[#1a365d]"
              />
              <span className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Self Signed Certificate</span>
            </label>
            <label className="flex items-center cursor-pointer">
              <input
                type="radio"
                ...
                className="w-4 h-4 text-[#1a365d] dark:text-blue-300 focus:ring-2 focus:ring-[#1a365d]"
              />
              <span className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Custom Certificate</span>
            </label>
          </div>
        </div>
        ...
        {certificateType === "selfSigned" && (
          <div className="w-full flex flex-col items-start space-y-4 border-t pt-6">
            <div className="text-sm font-medium text-gray-900 dark:text-gray-100 flex flex-col items-start">
        ...
        {certificateType === "custom" && (
          <div className="w-full flex flex-col items-start space-y-4 border-t pt-6">
            ...
            <div className="flex flex-col items-start w-full">
              <label htmlFor="privateKey" className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1 ml-1">Private Key:</label>
              <input
                type="file"
                id="privateKey"
                name="privateKey"
                ...
                className="p-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring focus:border-[#1a365d]/100 w-80"
              />
            </div>
            <div className="flex flex-col items-start w-full">
              <label htmlFor="publicCertificate" className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1 ml-1">Public Certificate:</label>
              <input
                type="file"
                ...
                className="w-80 p-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring focus:border-[#1a365d]/100"
              />
            </div>

            {validationMessages.length > 0 && (
              <div className="w-full mt-4 p-4 rounded-md border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/60">
                <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-3">Certificate Verification:</h3>
