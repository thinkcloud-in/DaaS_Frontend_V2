...
// Modal Component
export const RebuildPoolModal = ({ isOpen, onClose, onConfirm }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                <h2 className="text-lg font-semibold text-[#1a365d] mb-1">Rebuild Pool</h2>
                ...
                <input
                    ...
                    className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1a365d] mb-6"
                />
