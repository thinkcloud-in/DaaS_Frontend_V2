...
const DataStores = () => {
  ...
  const buildIframeUrl = () => {
    let url = `${DASHBOARD_GRAFANA_URL}/d/vsphereDS/vmware-vsphere-datastore?orgId=1&from=${gc.timeStamp.startDate}&to=${gc.timeStamp.endDate}&theme=${theme}&disableLazyLoad=true&kiosk`;
