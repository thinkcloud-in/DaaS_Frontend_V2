  ...
  <tr>
    {[...Array(6)].map((_, i) => (
      <td key={i} className="py-3 px-4">
        <div className="h-6 w-full bg-gray-100 dark:bg-gray-700 rounded animate-pulse"></div>
      </td>
    ))}
  </tr>
);
    ...
    <div className="p-2 md:p-4 h-full flex flex-col overflow-hidden">
      <div className="w-full md:w-[98%] h-[85vh] md:h-[90vh] flex-1 mx-auto bg-white dark:bg-gray-800 rounded-lg p-2 md:p-4 shadow-md flex flex-col overflow-hidden">
        <div className="mb-4 flex items-center justify-between px-2">
          <h2 className="text-xl font-bold text-[#1a365d] dark:text-blue-300">Session History</h2>
            ...
            <tbody className="text-gray-700 dark:text-gray-300">
              {loading ? (
                ...
                paginatedHistory.map((item) => {
                  ...
                  return (
                    <tr key={item.uuid} className="border-b border-gray-100 hover:bg-gray-50 dark:bg-gray-900/60 transition-colors">
                      ...
                      <td className="py-3 px-4 text-center">
                        {recordingUrl ? (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 text-[#1a365d] dark:text-blue-300 font-bold hover:underline"
                          >
      ...
      {iframeUrl && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-2 md:p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden relative">
            <button
