  ...
  return (
    <div className="h-[75vh] flex items-center justify-center m-3 p-5 border-dashed border-stone-300 border-2 bg-white dark:bg-gray-800">
      <div className="text-center">
        ...
        <p className="mb-2 text-lg text-gray-600 dark:text-gray-400">No Clusters Available</p>
        <p className="mb-8 text-gray-500 dark:text-gray-400">
          Get started by creating a new pool.
        </p>
        <div className="w-full flex justify-center items-center">
        <button 
  className="bg-[#1a365dcc] hover:bg-[#1a365d] hover:text-white text-[#f5f5f5] rounded-md px-3 py-2 text-sm font-medium flex flex-col gap-2"
