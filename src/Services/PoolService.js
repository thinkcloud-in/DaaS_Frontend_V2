...
export const fetchAssignedUsersService = async (token, machineId) => {
  const response = await axiosInstance.get(
    `${backendUrl}/v1/machine/users/${machineId}`,
    {
      headers: { Authorization: `Bearer ${token}` },
    },
  );
...
export const deleteAssignedUserService = async (
  token,
  machineIdentifier,
  user,
) => {
...
export const addUserToMachineService = async (
  token,
  machineIdentifier,
  usr,
) => {
...
export const getIpPoolNames = async (token) => {
  const response = await axiosInstance.get(
    `${backendUrl}/v1/ips/ip_pool_names`,
    {
      headers: { Authorization: `Bearer ${token}` },
    },
  );
...
export const getClusterNodes = async (token, cluster_id) => {
  const response = await axiosInstance.get(
    `${backendUrl}/v1/proxmox/get-cluster-nodes`,
    {
      params: { cluster_id },
      headers: { Authorization: `Bearer ${token}` },
    },
...
export const getTemplates = async (token, cluster_id) => {
  const response = await axiosInstance.get(
    `${backendUrl}/v1/proxmox/get_templates`,
    {
      params: { cluster_id },
      headers: { Authorization: `Bearer ${token}` },
    },
...
export const getVmwareFolders = async (token, cluster_id) => {
  const response = await axiosInstance.get(
    `${backendUrl}/v1/vmware/get-folders`,
    {
      params: { cluster_id },
      headers: { Authorization: `Bearer ${token}` },
    },
